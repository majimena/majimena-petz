...
public class ClinicInvitationControllerTest {
    ...
    public static class PostTest {
        ...
        public void 招待状を送信できること() throws Exception {
            ...
            mockMvc.perform(post("/api/clinics/100/invitations")
    ...
    public static class ActivateTest {
        ...
        public void 招待をアクティベートできること() throws Exception {
            ...
            mockMvc.perform(put("/api/clinics/100/invitations/1")
                .contentType(TestUtils.APPLICATION_JSON_UTF8)
                .param("email", "hoge@localhost.com")
                .content(TestUtils.convertObjectToJsonBytes(new ClinicInvitationAcceptionDTO("12345678901234567890"))))
                .andDo(print())
        ...
        public void アクティベーションキーが入力されていない場合はエラーになること() throws Exception {
            mockMvc.perform(put("/api/clinics/100/invitations/1")
                ...
                .andExpect(jsonPath("$.title", is(TestUtils.Title.VALIDATION_FAILED)))
                .andExpect(jsonPath("$.detail", is(TestUtils.Detail.ONE_VALIDATION_FAILED)))
                .andExpect(jsonPath("$.errors", hasSize(1)))
